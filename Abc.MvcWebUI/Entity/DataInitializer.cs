...
{
    //veritabanı degistiginde burdan tekrar olusturuyoruz.
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            foreach (var kategori in kategoriler)
            {
                ...
                context.Categorys.Add(kategori);
            }
            context.SaveChanges();
            ...
            var urunler = new List<Product>()
            {
                ...
                new Product(){ Name = "Dell Inspiron 5567 Intel Core i5 7200U 8GB 1TB R7 M445 Windows 10 Home 15.6 FHD Taşınabilir Bilgisayar FHDG20W81C", Price =1200 , Stock =500 , IsApproved =true , CategoryId = 2,Image="4.jpg"},
                ...
                new Product(){ Name = "Apple iPhone 6 32 GB (Apple Türkiye Garantili)", Price =1200 , Stock =500 , IsApproved =true , CategoryId = 4,Image="3.jpg"},
